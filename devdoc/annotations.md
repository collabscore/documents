...
```json  
{
	...
	"body": {
		"type": "SpecificResource",
		"resource": {
			"source": "http://localhost:8000/media/corpora/all/collabscore/tests/vivelevent/vvl.mp3",
			"selector": {
				"type": "FragmentSelector",
				"conformsTo": "https://www.w3.org/TR/media-frags/#naming-time",
				"value": "t=23,26"
	...
	"target": {
		"resource": {
			"source": "http://localhost:8000/media/corpora/all/collabscore/tests/vivelevent/mei.xml",
			"selector": {
				"type": "FragmentSelector",
				"conformsTo": "http://tools.ietf.org/rfc/rfc3023",
				"value": "P0m11n1"
